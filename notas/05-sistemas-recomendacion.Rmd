...
- Ratings  *explícitos* dados por los usuarios (por ejemplo, Netflix mucho tiempo fue así: 1-5 estrellas)
    **NOTE** cada vez menos usado, ya que obligas a los usuarios a rankear los items
...
```{r}
ejemplos(1324) %>% filter(num_calif_peli>300) %>% head(20) #The Professional
ejemplos(12293) %>% filter(num_calif_peli>300) %>% head(20) #The godfather
ejemplos(14691) %>% filter(num_calif_peli>300) %>% head(20) #The Matrix
```
