...
**NOTE** Se están seleccionando todas las transacciones por cliente, en lugar de seleccionar
transacciones al asar
...
**NOTE** No es posible porque no se puede solo poner en ceros los unos, ya que
se estarían eliminando otros elementos
...
**NOTE** Esta asignacion lo que ayuda es que no estamos compiando en cada
iteracion el vector v
v <-- añadir(v)

**NOTE** Otra solucion es hacer la funcion vectorizada, calcular todos los hashes 
al mismo tiempo
...
no es del todo adecuado, pues conforme vayamos
