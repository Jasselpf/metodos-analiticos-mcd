...
```{r gigante}
#supp was changes from 0.0001 to 0.01
pars_2 <- list(supp = 0.001, target='frequent itemsets', maxtime = 0, maxlen = 6)
...
**Note** Si Lift es mayor que 1 indica que hay asociación positiva
```{r}
...
sims_reglas <- lapply(1:10, function(i){
  ...
  ap_random <- apriori(trans, 
      parameter = list(support=0.002, confidence = 0.0, #confidence 0 indica que no filtramos nada
...
#La curva va disminuyendo a una tasa 1/(n^1/2)
```
